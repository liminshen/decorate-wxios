 ...
 * @LastEditors: sam.li
 * @LastEditTime: 2021-06-05 17:30:15
 */
...
export default function dispatchRequest(config) {
    ...
    // 合并处理 headers
    config.header = JSON.parse(JSON.stringify(utils.merge(
        {},
    ...
    return config.extends.isUpload ? Taro.upload(config) : Taro.request(config);
}
